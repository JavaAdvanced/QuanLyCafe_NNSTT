...
insert tblTtNhanVien (tenNv,gioiTinh,SDT,diaChi, caLam,tienLuong) values
	  (N'Bùi Van Sy','NAM','0947895039',N'Gio linh- Quang Tri',1,2000000)
	  insert tblTtNhanVien (tenNv,gioiTinh,SDT,diaChi, caLam,tienLuong) values
...
set dateformat YMD  insert tblHoaDon(idBan,ngay,tongTien)
	values (2,'2021-05-20',0)
	set dateformat YMD  insert tblHoaDon(idBan,ngay,tongTien)values
	(2,'2021-05-20',0)
	set dateformat YMD  insert tblHoaDon(idBan,ngay,tongTien)values
	(3,'2021-05-19',0)
	set dateformat YMD  insert tblHoaDon(idBan,ngay,tongTien)values
...
Select * From tblhanghoa, tblloai 
where tblhanghoa.idLoai = tblloai.idLoai